...
/* SWIPER options (home page)*/
    ...
    function stackLogosSwipe() {    
        ...
        var course_brand_cookie = Cookies.set('course-brand', swipeBrand, { domain: '.duchy.ac.uk' });
    ...
    $(".brand-image").click(function () {
        ...
        var course_brand_cookie = Cookies.set('course-brand', clickBrand, { domain: '.duchy.ac.uk' });
